    ...
    <main class="container-fluid px-4 py-4" style="max-width: 1320px;">
        ...
        <div class="card invoice-page-card mb-4">
            ...
            <div class="card-body pt-2">
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <input type="text" id="customer_id_display" class="form-control invoice-form-control"
                                   value="1 (Customer #1 - Mockup Data)" readonly disabled>
                ...
                <div class="mt-3 pt-3 border-top d-flex flex-wrap gap-3 align-items-center justify-content-between text-muted" style="font-size: 0.76rem;">
                    <div class="d-flex align-items-center gap-2">
                        <i class="bi bi-cpu text-primary"></i>
                        <span>Target Endpoint: <code class="code-pill">POST /receive-data</code></span>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <i class="bi bi-braces text-success"></i>
                        <span>Expected Request Payload: <code class="code-pill">{"customer_id": "1", "day_start": "...", "day_end": "..."}</code></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <span class="badge bg-light text-dark border px-2 py-1" style="font-size: 0.75rem;">
                        Total Logged: {{ $history->total() ?? count($history) }}
                    </span>
                </div>
            </div>
                    ...
                    <table class="invoice-items-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 28%;">Pipeline Message</th>
        ...
        <!-- System Architecture & Flow Helper Card -->
        <div class="card invoice-page-card mt-4" style="background: #fafbfc;">
            <div class="card-body py-3 px-4">
                <div class="row align-items-center text-muted" style="font-size: 0.8rem;">
                    <div class="col-md-4 mb-2 mb-md-0">
                        <strong class="text-dark d-block mb-1"><i class="bi bi-1-circle text-primary me-1"></i> Request Dispatch</strong>
                        Laravel sends <code class="code-pill">POST /receive-data</code> with <code class="code-pill">customer_id</code> and calendar range.
                    </div>
                    <div class="col-md-4 mb-2 mb-md-0">
                        <strong class="text-dark d-block mb-1"><i class="bi bi-2-circle text-warning me-1"></i> Immediate Response</strong>
                        Python returns <code class="code-pill">{"status_code": 1, ...}</code>, logged to table as <span class="badge-status badge-status-1 py-0 px-1" style="font-size: 0.7rem;">1 [IN PROGRESS]</span>.
                    </div>
                    <div class="col-md-4">
                        <strong class="text-dark d-block mb-1"><i class="bi bi-3-circle text-success me-1"></i> Async Calculation & Update</strong>
                        Python computes metrics, posts back to <code class="code-pill">/api/analytics-result/update</code>, changing status to <span class="badge-status badge-status-2 py-0 px-1" style="font-size: 0.7rem;">2 [SUCCESS]</span>.
                    </div>
                </div>
            </div>
        </div>

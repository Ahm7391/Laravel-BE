...
<body>
    ...
    <main class="hero-container">
        ...
        <div class="action-group">
            ...
            <button type="button" class="action-btn placeholder" onclick="showPlaceholderNotice('Forecasting Pipeline')">
                <span>Forecasting</span>
                <span>Pipeline</span>
            </button>

            <button type="button" class="action-btn placeholder" onclick="showPlaceholderNotice('OTA Scraping Demo')">
